...
%{ endif }
      ...
      artifact {
        ...
        source      = "s3::https://s3-${aws_region}.amazonaws.com/${bucket_name}/orchestrator?version=${orchestrator_checksum}"
        %{ else }
        source      = "s3::https://s3-${aws_region}.amazonaws.com/${bucket_name}/orchestrator"
        %{ endif }
      }
    }
  }
